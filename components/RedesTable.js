...
// Data exclusiva del departamento de Redes
const EQUIPOS_DATA_REDES = [
  { id: 'HW-005', tipo: 'Switch', marca: 'Cisco Catalyst 1000', serial: 'CSC-8820-NW', depto: 'Redes', responsable: 'Pedro Rojas', estado: 'Operativo', fecha: '2023-09-12' },
  { id: 'HW-006', tipo: 'UPS', marca: 'APC Smart-UPS 1500', serial: 'APC-3347-UP', depto: 'Redes', responsable: 'Pedro Rojas', estado: 'Dañado', fecha: '2022-05-30' },
  { id: 'HW-007', tipo: 'Servidor', marca: 'Dell PowerEdge R740', serial: 'DLL-9912-SV', depto: 'Redes', responsable: 'Pedro Rojas', estado: 'Operativo', fecha: '2023-04-18' },
  { id: 'HW-009', tipo: 'Laptop', marca: 'Dell Latitude 5520', serial: 'DLL-2210-LT', depto: 'Redes', responsable: 'Gabriela Torres', estado: 'En Reparación', fecha: '2024-07-22' },
  { id: 'HW-020', tipo: 'Router', marca: 'MikroTik CCR2004', serial: 'MIK-1092-RT', depto: 'Redes', responsable: 'Gabriela Torres', estado: 'Operativo', fecha: '2024-01-10' },
  { id: 'HW-021', tipo: 'Switch', marca: 'Ubiquiti UniFi Pro', serial: 'UBQ-4451-SW', depto: 'Redes', responsable: 'Pedro Rojas', estado: 'Operativo', fecha: '2024-03-01' },
];
...
export default function RedesTable() {
  const [equipos, setEquipos] = useState(EQUIPOS_DATA_REDES);
  ...
  const handleExportar = (periodo) => {
    showAlert('Reporte PDF', `Generando reporte PDF de Redes para: ${periodo}`, 'info');
  };
  ...
  const handleAddEquipo = (formData) => {
    const nextNum = equipos.length + 300; 
    ...
    const newEquipo = {
      ...
      depto: 'Redes', // Forzamos el modulo
  ...
  // This handleExportar is for CSV export, if needed directly
  const handleExportarCSV = () => {
    const headers = ['ID', 'Tipo', 'Marca/Modelo', 'Serial', 'Departamento', 'Responsable', 'Estado', 'Fecha Registro'];
    const rows = sortedData.map(eq =>
      [eq.id, eq.tipo, eq.marca, eq.serial, eq.depto, eq.responsable, eq.estado, eq.fecha].join(',')
    );
    ...
    link.href = url;
    link.download = `inventario_redes_${new Date().toISOString().slice(0, 10)}.csv`;
    link.click();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tableCard}>
        ...
        <View style={styles.headerRow1}>
          <Text style={styles.title}>🌐 Inventario de Redes</Text>
          <View style={styles.searchBox}>
            <Text style={styles.lupaIcon}>⌕</Text>
            <TextInput
              style={styles.searchInput}
              placeholder="Buscar por ID, tipo, marca..."
