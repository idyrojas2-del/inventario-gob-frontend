...
const EQUIPOS_DATA = [
  { id: 'HW-001', tipo: 'PC Escritorio', marca: 'Dell OptiPlex 7090', serial: 'DLL-4829-XK', depto: 'Recursos Humanos', responsable: 'Carlos Mendoza', estado: 'Operativo', fecha: '2024-03-15' },
  { id: 'HW-002', tipo: 'Laptop', marca: 'Lenovo ThinkPad T14', serial: 'LNV-7731-QR', depto: 'Despacho', responsable: 'Ana García', estado: 'Operativo', fecha: '2024-01-20' },
  { id: 'HW-003', tipo: 'Impresora', marca: 'HP LaserJet Pro M404', serial: 'HPQ-1193-AB', depto: 'Administración', responsable: 'Luis Pérez', estado: 'Esperando Repuestos', fecha: '2023-11-08' },
  ...
  { id: 'HW-005', tipo: 'Switch', marca: 'Cisco Catalyst 1000', serial: 'CSC-8820-NW', depto: 'Site Principal', responsable: 'Pedro Rojas', estado: 'Operativo', fecha: '2023-09-12' },
  { id: 'HW-006', tipo: 'UPS', marca: 'APC Smart-UPS 1500', serial: 'APC-3347-UP', depto: 'Site Principal', responsable: 'Pedro Rojas', estado: 'Dañado', fecha: '2022-05-30' },
  { id: 'HW-007', tipo: 'Servidor', marca: 'Dell PowerEdge R740', serial: 'DLL-9912-SV', depto: 'Site Principal', responsable: 'Pedro Rojas', estado: 'Operativo', fecha: '2023-04-18' },
  ...
  { id: 'HW-009', tipo: 'Laptop', marca: 'Dell Latitude 5520', serial: 'DLL-2210-LT', depto: 'Redes', responsable: 'Gabriela Torres', estado: 'Operativo', fecha: '2024-07-22' },
  { id: 'HW-010', tipo: 'Impresora', marca: 'Epson L3250', serial: 'EPS-4480-IJ', depto: 'Recursos Humanos', responsable: 'Carlos Mendoza', estado: 'Dañado', fecha: '2023-08-05' },
];
...
export default function InventarioReparacionesTable() {
  ...
  const handleExportar = (periodo) => {
    showAlert('Reporte PDF', `Generando reporte PDF de Reparaciones para: ${periodo}`, 'info');
  };
  ...
  const conteo = {
    ...
    esperando: filtered.filter(e => e.estado === 'Esperando Repuestos').length,
    reparacion: filtered.filter(e => e.estado === 'En Reparación').length,
    danado: filtered.filter(e => e.estado === 'Dañado').length,
  };

  const handleAddEquipo = (formData) => {
    const nextNum = equipos.length + 1;
  ...
  const getBadgeStyle = (estado) => {
    switch (estado) {
      ...
      case 'Esperando Repuestos': return { bg: '#ffedd5', text: '#c2410c' }; // Orange
      case 'En Reparación': return { bg: '#fef3c7', text: '#92400e' }; // Amber
    ...
    <View style={styles.container}>
      ...
      <View style={styles.statsRow}>
        <View style={[styles.statCard, { borderLeftColor: '#002750' }]}>
          ...
          <Text style={styles.statLabel}>Totales Pendientes</Text>
        </View>
        ...
        <View style={[styles.statCard, { borderLeftColor: '#f97316' }]}>
          <Text style={[styles.statNumber, { color: '#f97316' }]}>{conteo.esperando}</Text>
          <Text style={styles.statLabel}>Espera Repuestos</Text>
        </View>
      ...
      <View style={styles.tableCard}>
        ...
        <View style={styles.headerRow1}>
          <Text style={styles.title}>🛠️ Inventario de Reparaciones</Text>
      ...
      <NewEquipmentModal
        ...
        customEstados={['En Reparación', 'Esperando Repuestos', 'Dañado']}
      />
      <ExportPDFModal
