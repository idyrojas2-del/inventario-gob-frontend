...
// Data exclusiva del departamento de Administración
const EQUIPOS_DATA_ADMIN = [
  { id: 'HW-011', tipo: 'Impresora', marca: 'HP LaserJet Pro M404', serial: 'HPQ-1193-AB', depto: 'Administración', responsable: 'Luis Pérez', estado: 'Esperando Repuestos', fecha: '2023-11-08' },
  { id: 'HW-012', tipo: 'Laptop', marca: 'Lenovo ThinkPad E15', serial: 'LNV-8842-XT', depto: 'Administración', responsable: 'Laura Gomez', estado: 'Operativo', fecha: '2024-02-14' },
  { id: 'HW-013', tipo: 'PC Escritorio', marca: 'Dell OptiPlex 3080', serial: 'DLL-3321-PO', depto: 'Administración', responsable: 'Miguel Sanchez', estado: 'Operativo', fecha: '2023-10-05' },
  { id: 'HW-014', tipo: 'Monitor', marca: 'LG 24" FHD', serial: 'LGe-5541-ZZ', depto: 'Administración', responsable: 'Miguel Sanchez', estado: 'En Reparación', fecha: '2023-10-05' },
  { id: 'HW-015', tipo: 'Trituradora', marca: 'Fellowes Powershred', serial: 'FLW-0092-AA', depto: 'Administración', responsable: 'Laura Gomez', estado: 'Dañado', fecha: '2022-01-20' },
];
...
export default function AdministracionTable() {
  const [equipos, setEquipos] = useState(EQUIPOS_DATA_ADMIN);
  ...
  const handleExportar = (periodo) => {
    showAlert('Reporte PDF', `Generando reporte PDF de Administración para: ${periodo}`, 'info');
  };
  ...
  const conteo = {
    ...
    reparacion: equipos.filter(e => e.estado === 'En Reparación' || e.estado === 'Esperando Repuestos').length,
    danado: equipos.filter(e => e.estado === 'Dañado').length,
  };

  const handleAddEquipo = (formData) => {
    const nextNum = equipos.length + 400; 
    ...
    const newEquipo = {
      ...
      depto: 'Administración', // Forzamos el modulo
  ...
  const getBadgeStyle = (estado) => {
    switch (estado) {
      ...
      case 'Esperando Repuestos': return { bg: '#ffedd5', text: '#c2410c' };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tableCard}>
        ...
        <View style={styles.headerRow1}>
          <Text style={styles.title}>📁 Inventario de Administración</Text>
